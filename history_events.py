...
def get_tajikistan_history():
    ...
    """
    try:
        # ДОБАВЬТЕ ЭТУ СТРОКУ ДЛЯ ДЕБАГА:
        print(f"🔍 Проверяем дату: {datetime.now().month:02d}{datetime.now().day:02d}")
        ...
        # ДОБАВЬТЕ ЭТУ СТРОКУ ДЛЯ ДЕБАГА:
        print(f"🔍 Ищем ключ: {date_key}")
        print(f"🔍 Доступные ключи: {list(events_db.keys())[:5]}...")  # покажем первые 5 ключей
